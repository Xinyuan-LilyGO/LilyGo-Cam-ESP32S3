...
#define _PWDN_GPIO_NUM               (-1)
#define _RESET_GPIO_NUM              (39)
#define _XCLK_GPIO_NUM               (38)
#define _SIOD_GPIO_NUM               (5)
#define _SIOC_GPIO_NUM               (4)
#define _VSYNC_GPIO_NUM              (8)
#define _HREF_GPIO_NUM               (18)
#define _PCLK_GPIO_NUM               (12)
#define _Y9_GPIO_NUM                 (9)
#define _Y8_GPIO_NUM                 (10)
#define _Y7_GPIO_NUM                 (11)
#define _Y6_GPIO_NUM                 (13)
#define _Y5_GPIO_NUM                 (21)
#define _Y4_GPIO_NUM                 (48)
#define _Y3_GPIO_NUM                 (47)
#define _Y2_GPIO_NUM                 (14)
